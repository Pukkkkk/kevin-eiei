...
public class AICreateBarrack : AICreateHQ
{
    ...
    private bool CheckIfAnyUnfinishedHouseAndBarrack()
    {
        ...
        foreach (GameObject barrackObj in support.Barrack)
        {
    ...
    public override float GetWeight()
    {
        ...
        if (support.Barrack.Count < 2 && support.House.Count > 0) // If there are less than 2 barracks and there are some houses
            return 2;
